...
def check_downloaded_model(filecoin_hash: str, output_dir: Path = DEFAULT_MODEL_DIR) -> bool:
    """
...
async def download_model_from_filecoin_async(filecoin_hash: str, output_dir: Path = DEFAULT_MODEL_DIR) -> str | None:
    """
